...
/* XOR and copy less than word bytes efficiently (may read out of bounds) */
...
/* XOR and copy less than word bytes efficiently (won't read out of bounds) */
#if WL_OPTIMIZE&4 != WL_OPTIMIZE_SIZE
	always_inline
#endif
static void _axrsws(
