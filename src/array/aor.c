...
/* OR and copy less than word bytes efficiently (may read out of bounds) */
...
/* OR and copy less than word bytes efficiently (won't read out of bounds) */
#if WL_OPTIMIZE&4 != WL_OPTIMIZE_SIZE
	always_inline
#endif
static void _aorsws(
